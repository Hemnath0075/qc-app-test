...
function VideoAnalysis({ isCollapsed }) {
  const video_table = [
    {
      title: "Time",
      ...
      render: (_, { timestring }) => (
        <>
          <div className="w-full flex justify-center items-center text-[#4B5565]">
            <p className="underline text-[#2660ff]" onClick={()=>handleSetTime(10)}>{timestring}</p>
          </div>
        </>
      ),
    },
  ...
  const handleSetTime = (timeInSeconds) => {
    if (videoRef.current) {
      ...
      videoRef.current.play(); // Optional: Automatically play after seeking
    }
  };
  ...
  return (
    ...
    >
      ...
      <div className="px-8 py-1">
        <div className="bg-white h-[95vh] mt-4 w-full rounded-[10px] flex flex-row-reverse">
          <div className="basis-[60%] px-8">
            <h2 className="text-2xl py-4 ml-[5vw]">Video</h2>
            <div className="basis-[50%] flex flex-col h-full gap-4">
              <div className="w-[full] h-[auto] flex flex-col gap-2">
                {true && (
                  ...
                  <video
                    ...
                    ref={videoRef}
                    controls
                    className="z-[100000] w-[auto] h-[50vh]"
                    loop
                    muted
                    autoPlay
                  ></video>
                ...
                <div className="w-full flex flex-row justify-center items-center">
                  <Table
                    className="font-[inter] basis-[80%] border border-[#CDD5DF] rounded-[10px]"
          ...
          <div className="basis-[40%] py-4 px-2 flex flex-col gap-2">
            <div className="h-full bg-[#F7F7F7] rounded-[10px] border-2 border-[#CDD5DF] flex flex-col px-8 py-4">
              <p className="text-2xl">Video Analysis</p>
              <div className="mt-8 flex flex-row justify-start items-center text-lg text-[#000000]">
                <p className="font-[400] text-xl">Stoppage Type: </p>
                <p className="font-[600] ml-4 text-xl">{"   Minor Stoppage"}</p>
              </div>
              <div className="flex flex-col mt-10 gap-4">
                ...
                <div className="mt-2 flex flex-row justify-between items-center text-lg text-[#697586]">
                  <p>Time Taken to Start Repair</p>
                  <p>{"30mins"}</p>
                </div>
                <div className="mt-2 flex flex-row justify-between items-center text-lg text-[#697586]">
                  <p>Repair Duration</p>
